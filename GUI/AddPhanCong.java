 ...
 * @author tien
 */
public class AddPhanCong extends javax.swing.JFrame {

    /**
     * Creates new form UpdateProduct
     */
    private int id;
    public AddPhanCong(int id) {
        initComponents();
        this.id=id;
    ...
    private void initComponents() {
        ...
        jPanel1.add(kGradientPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 180, -1, -1));
